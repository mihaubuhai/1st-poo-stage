...
public class FollowStats implements Comparable {
        ...
        */
        if (selectInfo == null || !selectInfo.getSelected()) {
            ...
            if (selectInfo.getResultType() != playlistId) {
                ...
                */
                UserInfo currUser = findUser(users, command.getUsername());
                ...
                String currPlaylist = selectInfo.getPlaylist().getDetails().getName();
                for (Playlist playlist: currUser.getPlaylists()) {
                    String tempPlaylist = playlist.getDetails().getName();
                ...
                if (!isUsers) {
                    ...
                    if (follows == null) {
                        ...
                        follows.setTimeCreation(selectInfo.getPlaylist().getTimeCreation());
                    ...
                    */
                    ...
                    for (String playlits: currUser.getFwdPlaylits()) {
                        if (playlits.equals(currPlaylist)) {
                            ...
                            selectedPlaylist.getDetails().decFollowers();
                    ...
                    if (!isFollowed) {
                        ...
                        selectedPlaylist.getDetails().incFollower();
    ...
    public UserInfo findUser(final ArrayList<UserInfo> users, final String username) {
